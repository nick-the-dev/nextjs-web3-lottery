      ...
      <div className="cards-wrapper">
        <Card>
          <div className="img-wrapper">
            <Image src="/assets/team-d.jpg" width={143} height={143} alt="Team Profile Icon" />
          </div>
          <span className="letters">Maheen Knapp</span>
          <span className="position">Founder</span>
          <span className="desc">
            Crypto Entrepreneur with 9 years’ experience in the sports and gaming industries.
          </span>
        </Card>
        <Card>
          <div className="img-wrapper">
            <Image src="/assets/team-a.jpg" width={143} height={143} alt="Team Profile Icon" />
          </div>
          <span className="letters">Mateo Morse</span>
          <span className="position">Full-Stack Developer</span>
          <span className="desc">
            {" "}
            10 years’ experience. Development of website backend and frontend, smart contracts.
          </span>
        </Card>
        <Card>
          <div className="img-wrapper">
            <Image src="/assets/team-c.jpg" width={143} height={143} alt="Team Profile Icon" />
          </div>
        ...
        <Card>
          <div className="img-wrapper">
            <Image src="/assets/team-b.jpg" width={143} height={143} alt="Team Profile Icon" />
          </div>
