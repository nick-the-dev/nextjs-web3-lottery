  ...
  return (
    <section className="info">
      ...
      <div className="cards-wrapper">
        <button type="button" className="info-card">
          <div className="inner">
        ...
        <button type="button" className="info-card">
          <div className="inner">
            ...
            <p className="card-desc">
            {"NFT Loottery is a unique opportunity to significantly increase your profits! Each Loottery NFT is a ticket to participate in our lotteries to win 1 ETH, GOLD TICKET and some juicy prizes..."}
            </p>
          </div>
        </button>
      </div>
